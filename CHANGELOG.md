...
### Changes
* Plugin refactor. Now even actions are considered core plugins. Scanning snooze.plugins.core.basic.plugin folder instead of declaring plugins in core.yaml
